...
CREATE TABLE AIRCRAFT_MODEL (
  ...
  MOTOR VARCHAR(50) NOT NULL REFERENCES MOTORIZATION(MOTOR) ON DELETE CASCADE,
...
CREATE TABLE CDRAG_FUNCTION (
  ...
  ID_AIRCRAFT_MODEL VARCHAR(25) NOT NULL REFERENCES AIRCRAFT_MODEL(ID_AIRCRAFT_MODEL) ON DELETE CASCADE,
...
CREATE TABLE AIRPORT (
  ...
  ID_COORDINATE VARCHAR(25) NOT NULL REFERENCES COORDINATE(ID_COORDINATE) ON DELETE CASCADE,
  ID_PROJECT INTEGER NOT NULL REFERENCES PROJECT(ID_PROJECT) ON DELETE CASCADE
);

CREATE TABLE STOP (
  ID_STOP INTEGER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
  IATA CHAR(3) NOT NULL REFERENCES AIRPORT(IATA) ON DELETE CASCADE,
...
CREATE TABLE FLIGHT_INFO (
  ...
  ORIGIN_AIRPORT CHAR(3) NOT NULL REFERENCES AIRPORT(IATA) ON DELETE CASCADE,
  DEST_AIRPORT CHAR(3) NOT NULL REFERENCES AIRPORT(IATA) ON DELETE CASCADE,
  FLIGHT_TYPE VARCHAR(25) NOT NULL REFERENCES FLIGHT_TYPE(TYPE),
  ID_AICRAFT INTEGER NOT NULL REFERENCES AIRCRAFT(ID_AIRCRAFT) ON DELETE CASCADE,
  ID_PROJECT INTEGER NOT NULL REFERENCES PROJECT(ID_PROJECT) ON DELETE CASCADE
);

CREATE TABLE FLIGHT_STOP (
  FLIGHT_INFO VARCHAR(7) NOT NULL REFERENCES FLIGHT_INFO(DESIGNATOR) ON DELETE CASCADE,
...
CREATE TABLE WAYPOINT (
  ID_COORDINATE VARCHAR(25) NOT NULL REFERENCES COORDINATE(ID_COORDINATE) ON DELETE CASCADE,
  FLIGHT_INFO_DESIGNATOR VARCHAR(7) NOT NULL REFERENCES FLIGHT_INFO(DESIGNATOR) ON DELETE CASCADE,
...
CREATE TABLE FLIGHT_PLAN (
  ID_SEGMENT VARCHAR(25) NOT NULL REFERENCES SEGMENT(ID_SEGMENT) ON DELETE CASCADE,
  ID_FLIGHT_SIMULATION INTEGER NOT NULL REFERENCES FLIGHT_SIMULATION(ID_FLIGHT_SIMULATION) ON DELETE CASCADE,
