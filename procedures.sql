...
CREATE OR REPLACE PROCEDURE PC_ADD_SEGMENT
  (L_SEGMENT_CODE IN VARCHAR,
   ...
   L_ORIGIN_COORDINATE IN NUMBER,
   L_DEST_COORDINATE IN NUMBER)
IS
...
BEGIN
  ...
  VALUES
  (L_SEGMENT_CODE, L_WIND_DIRECTION, L_WIND_INTENSITY, L_ALTITUDE, L_ID_PROJECT, L_ORIGIN_COORDINATE, L_DEST_COORDINATE);
