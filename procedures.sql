...
BEGIN
  ...
  VALUES
  (L_MOTOR, L_NUMBER_MOTORS, L_CRUISE_ALTITUDE, L_CRUISE_SPEED,
  ...
  L_MOTOR, L_EMPTY_WEIGHT, L_MTOW, L_FUEL_CAPACITY, L_VMO, L_MMO, L_WING_AREA, 
  L_WING_SPAN, L_ASPECT_RATIO, L_E);
...
CREATE OR REPLACE PROCEDURE PC_EDIT_PROJECT
