...
-- procedure to create an airport into a given project
 ...
 ( L_IATA IN CHAR,
   ...
   L_ID_COORDINATE IN VARCHAR,
   L_ID_PROJECT IN INTEGER) IS

 BEGIN

   INSERT INTO AIRPORT (IATA, NAME, TOWN, COUNTRY, ALTITUDE, ID_COORDINATE, ID_PROJECT) 
   VALUES (L_IATA, L_NAME, L_TOWN, L_COUNTRY, L_ALTITUDE, L_ID_COORDINATE, L_ID_PROJECT);
